...
void IntListInsertInOrder(IntList L, int v)
{
    ...
    if (head == NULL) {
        ...
        // Otherwise (Either middle or placed after last)
        // shifts to previous on 1st node, curr to second node
        previous = curr;
        curr = curr->next;
